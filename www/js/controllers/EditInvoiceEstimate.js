angular.module('myApp.controllers')
        ...
        .controller('EditInvoiceEstimateCtrl', function ($scope, $state, $http, $stateParams, Utils, $ionicNavBarDelegate, AppConfig, $ionicModal, $ionicScrollDelegate, $window, $rootScope) {
...
//////////////////////////////////////////////////////////////
           ...
           */
          $(document).on('search', '#productsSearchForm', function () {
            $scope.loadProducts();
          });
